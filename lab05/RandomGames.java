...
public class RandomGames {
        ...
        else if (game.equalsIgnoreCase("C")){ //elseif statement that ignore case of letter
                System.out.println ("Craps option is yet to be implemented."); //output where option is not implemented
            } // end of if statement for c 
        else if (game.equalsIgnoreCase("P")){ //elseif statement that ignores case of letter
